...
export function useI18n(){const{language,setLanguage,dictionary}=useLanguage();return{locale:language,setLocale:setLanguage,dictionary,t:(key:string)=>{const[a,b]=key.split('.',2);const section=dictionary[a as keyof typeof dictionary] as Record<string,unknown>|undefined;const value=section?.[b??''];return typeof value==='string'?value:key}}}
