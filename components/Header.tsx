      ...
      <header className="sticky top-0 z-30 border-b border-white/5 bg-zinc-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-4 px-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/ranking" className="hidden items-center gap-2 rounded-full border border-white/8 bg-white/[0.03] px-3.5 py-2 text-xs font-semibold text-zinc-400 transition hover:bg-white/[0.07] hover:text-zinc-100 md:inline-flex"><Trophy size={14}/>Hall of Fame</Link>
            <NotificationCenter />
